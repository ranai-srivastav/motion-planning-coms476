...
(cl:defmethod cl:initialize-instance :after ((m <Point>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name FinalProject-msg:<Point> is deprecated: use FinalProject-msg:Point instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader FinalProject-msg:x-val is deprecated.  Use FinalProject-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader FinalProject-msg:y-val is deprecated.  Use FinalProject-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Point>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader FinalProject-msg:theta-val is deprecated.  Use FinalProject-msg:theta instead.")
  (theta m))
